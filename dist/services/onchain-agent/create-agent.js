...
exports.createOnchainAgent = void 0;
exports.createAgent = createAgent;
const agentkit_langchain_1 = require("@coinbase/agentkit-langchain");
const openai_1 = require("@langchain/openai");
const prepare_agentkit_1 = require("./prepare-agentkit");
/**
...
async function createAgent(userId = "default") {
    ...
    try {
        ...
        const { agentkit, walletProvider } = await (0, prepare_agentkit_1.prepareAgentkitAndWalletProvider)(userId);
 ...
 */
exports.createOnchainAgent = createAgent;
